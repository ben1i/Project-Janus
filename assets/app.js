...
const emotes = ['./assets/images/emotes/aga-4x.png', './assets/images/emotes/AROUND-4x.gif', './assets/images/emotes/Awkward-4x.gif', './assets/images/emotes/AWOOGA-4x.gif', './assets/images/emotes/baskin-4x.png', './assets/images/emotes/bye-4x.gif', './assets/images/emotes/classic-4x.gif', './assets/images/emotes/Dogsled-4x.png', './assets/images/emotes/Gooning-4x.png', './assets/images/emotes/heyyyy-4x.gif', './assets/images/emotes/hi-4x.gif', './assets/images/emotes/HIM-4x.gif', './assets/images/emotes/mhm-4x.gif', './assets/images/emotes/mmmmm-4x.png', './assets/images/emotes/NOOOO-4x.gif', './assets/images/emotes/om-4x.gif', './assets/images/emotes/PAGGING-4x.gif', './assets/images/emotes/Streamer-4x.png', './assets/images/emotes/uuh-4x.gif', './assets/images/emotes/WHAT-4x.gif', './assets/images/emotes/Who-4x.gif', ];
const emotesData = ['../assets/images/emotes/aga-4x.png', '../assets/images/emotes/AROUND-4x.gif', '../assets/images/emotes/Awkward-4x.gif', '../assets/images/emotes/AWOOGA-4x.gif', '../assets/images/emotes/baskin-4x.png', '../assets/images/emotes/bye-4x.gif', '../assets/images/emotes/classic-4x.gif', '../assets/images/emotes/Dogsled-4x.png', '../assets/images/emotes/Gooning-4x.png', '../assets/images/emotes/heyyyy-4x.gif', '../assets/images/emotes/hi-4x.gif', '../assets/images/emotes/HIM-4x.gif', '../assets/images/emotes/mhm-4x.gif', '../assets/images/emotes/mmmmm-4x.png', '../assets/images/emotes/NOOOO-4x.gif', '../assets/images/emotes/om-4x.gif', '../assets/images/emotes/PAGGING-4x.gif', '../assets/images/emotes/Streamer-4x.png', '../assets/images/emotes/uuh-4x.gif', '../assets/images/emotes/WHAT-4x.gif', '../assets/images/emotes/Who-4x.gif', ];

const nav = document.querySelector('.header__nav');
const navExit = document.querySelector(".header__exit");
const burgerMenu = document.querySelector(".header__burgerMenu");

const dataSocial = document.querySelector('.data__social');
